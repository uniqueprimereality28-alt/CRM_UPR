                ...
                <div className="mt-4 space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="mt-1 text-sm font-mono text-slate-800"
                      placeholder="Maine aapki saari requirement note kar li hai — aapko {config} property chahiye {location} mein under {budget} for {purpose}. Main ye saari details hamari senior team ke sath share kar rahi hoon and they will get in touch with you shortly. Thank you so much for your time, have a nice day!"
                    />
                    <p className="text-[11px] text-slate-400 mt-1">
            ...
            <div className="mt-5 grid gap-4 sm:grid-cols-2">
              ...
              <div>
                ...
                <Select value={telephony.sarvam_speaker} onValueChange={(v) => setTelephony({ ...telephony, sarvam_speaker: v })}>
                  ...
                  <SelectContent>
                    <SelectItem value="simran">Simran (Female · Top Real Estate Telecaller Accent)</SelectItem>
                    <SelectItem value="priya">Priya (Female · Warm & Engaging)</SelectItem>
                    <SelectItem value="kavya">Kavya (Female · Natural Hindi/Hinglish)</SelectItem>
                    ...
                    <SelectItem value="rahul">Rahul (Male · Confident)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
